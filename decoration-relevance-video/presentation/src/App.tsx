...
/** Show subtitles when ?sub=1 is in the URL */
const showSubtitles = new URLSearchParams(window.location.search).get("sub") === "1";
  ...
  return (
    <>
      <Stage onAdvance={stepper.next}>
        ...
        <Subtitle text={stepText} visible={showSubtitles} />
      </Stage>
      <ProgressBar
        chapters={CHAPTERS}
