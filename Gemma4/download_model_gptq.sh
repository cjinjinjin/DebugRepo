#!/bin/bash
# Download GPTQ 4-bit quantized Gemma 4 26B-A4B-it
# Source: https://huggingface.co/raydelossantos/gemma-4-26B-A4B-it-GPTQ-Int4
#
# Usage:
#   bash Gemma4/download_model_gptq.sh
#   HF_TOKEN=hf_xxx bash Gemma4/download_model_gptq.sh
set -euo pipefail

REPO_ID="raydelossantos/gemma-4-26B-A4B-it-GPTQ-Int4"
MODEL_NAME="gemma-4-26B-A4B-it-GPTQ-Int4"
...
if [ -z "${HF_TOKEN:-}" ]; then
    ...
    echo "  bash Gemma4/download_model_gptq.sh"
    exit 1
fi

echo "============================================"
echo "Download Gemma 4 26B-A4B-it GPTQ Int4"
echo "============================================"
echo "Repo:       ${REPO_ID}"
