...
EXPERIMENT_NAME="grpo_27b_zero2_bf16_len2048_comp2048_gen2"
export SFT_ADAPTER=""

export GRPO_PRESET="stable_grpo_zero2_qlora"
export MODEL_PATH="${MODEL_PATH:-/vc_data/shares/bingads.algo.prod.adsplus/ProdAdsPlusShare/Team/RichAds/AIGC/CKPT/qwen35_27b_sft_lora_cot_v1/merged_model}"
export DATA_DIR="${SCRIPT_DIR}/data"
export OUTPUT_DIR="/vc_data/shares/bingads.algo.prod.adsplus/ProdAdsPlusShare/Team/RichAds/AIGC/CKPT/qwen35_27b_grpo_experiments/${EXPERIMENT_NAME}"
export DEEPSPEED_CONFIG="zero2"
export REWARD_PLUGIN="${SCRIPT_DIR}/reward_grpo.py"

# 27B dense model fits in BF16 on 8xA100, no need for QLoRA
