#!/bin/bash
# Evaluate the fine-tuned Qwen3-14B CoT model using swift infer (batch inference)
# then run evaluate.py on the results.
#
# Usage:
#   bash eval_swift_cot_14b.sh [checkpoint_dir]
...
ADAPTER_PATH="${1:-/vc_data/shares/bingads.algo.prod.adsplus/ProdAdsPlusShare/Team/RichAds/AIGC/CKPT/qwen3_14b_sft_lora_cot_v1/best_checkpoint}"
...
# 14B dense model: tp=4 is sufficient (or tp=8 for max throughput)
