...
### 10b. 方案十 comp1024 重跑结果（2026-04-05，前 5 steps）
...
- **关键发现**：
  ...
  3. **clipped_ratio 已稳定**：step 3 的 0.22 是 batch 波动，step 4-5 均为 0.109，训练未加剧截断
  4. **reward 在 0.40-0.47 之间波动**：均值 ~0.444，远超 SFT baseline（0.211），但尚无明确上升趋势
