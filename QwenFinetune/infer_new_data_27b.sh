#!/bin/bash
# Inference pipeline for new raw TSV data using the Qwen3.5-27B fine-tuned checkpoint.
#
# Usage:
#   bash infer_new_data_27b.sh [tsv_file] [checkpoint_dir] [think|nothink] [temperature]
...
ADAPTER_PATH="${2:-/vc_data/shares/bingads.algo.prod.adsplus/ProdAdsPlusShare/Team/RichAds/AIGC/CKPT/qwen35_27b_dpo_lora_cot_v1/best_checkpoint}"
...
mkdir -p "${RESULTS_DIR}"
cp "$0" "${RESULTS_DIR}/infer_new_data_27b.sh"
